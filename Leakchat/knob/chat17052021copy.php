                        ...
                        <div class='textbox d-none disabled'>
                            <?php if (!$GLOBALS["logged"]) {
                                ...
                                <span class='box'>
                                    ...
                                    <i class='sendbtn ' onclick="notifyMe()"><i></i></i>
  ...
  if (!("Notification" in window)) {
    alert("This browser does not support desktop notification");
        ...
        var options = {
                ...
                icon: "assets/markers/blue_marker.png",
                dir : "ltr"
             };
...
//}, 5000);
        ...
        function notifyMe2() {
          ...
          // alert($('.userimagepushnotification').attr('src'));
      ...
      //  e.preventDefault();
        ...
        if(Notification.permission === 'default'){
            ...
            notify = new Notification('New Message From Romzik', {
                ...
                icon: 'https://cdn.icon-icons.com/icons2/37/PNG/512/online_4158.png',
...
/*dkrBk9I03yo:APA91bH8dryRdhE60a9o4JqoKQIWLSYoyL3B6iKPo5R0dvpEryggBSI0mvefZ2TKBgnz9hIVvxOdBrSPjVaHuOb_vo26kw2ZU_jke_FizK6uTNA1CsnltlwI-05Uw4h--2LpSXCI9Iqf
*/
}
