    ...
    <i class="gi-menu mmenu subnav">
        <div class='swr-menu'>
            <ul>
                ...
                <li class='ajx logout_update' id="logout_update" data-act=1 data-do='logout'><?php gec($GLOBALS["lang"]->logout) ?></li>
                  <!--li class='ajx logout_update' id="logout_update" ><php gec($GLOBALS["lang"]->logout) ?></li-->
            </ul>
        </div>
