...
if (isset($_POST['signup'])) {
  ...
  echo $emaill;
  if(substr_count($emaill, "@citycollege.sheffield.eu")===1) {
  ...
  $emailValid = "Your email address is invalid. You shoud use only @citycollege.sheffield.eu mail.";
  }
  // }
}
?>
      ...
      <form name="empsignup" enctype="multipart/form-data" method="post">
        <section class="resum-form padd-tb">
          ...
          <div class="container">
            ...
            <?php if (@$emailValid) { ?><div class="errorWrap">
              <strong>ERROR</strong> : <?php echo htmlentities($emailValid); ?>
            </div><?php } ?>
            <div class="row">
