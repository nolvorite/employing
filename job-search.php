              ...
              <div id="content-area">
                ...
                <ul id="myList">
                  ...
                  <li>
                    ...
                    $vid = $_GET['viewid'];
                    $sql = "SELECT tbljobs.*,tblemployers.CompnayLogo,tblemployers.CompnayName from tbljobs join tblemployers on tblemployers.id=tbljobs.employerId where tbljobs.jobTitle='{$jobtitle}' or tblemployers.CompnayName='{$company}' or tbljobs.jobLocation='{$location}'  LIMIT $offset, $no_of_records_per_page";
