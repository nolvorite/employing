...
if (strlen($_SESSION['jpaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $AName=$_POST['DirectorName'];
  $mobno=$_POST['mobilenumber'];
  $email=$_POST['email'];
  $sql="update tbldirector set DirectorName=:DirectorName,MobileNumber=:mobilenumber,Email=:email where ID=:aid";
     $query = $dbh->prepare($sql);
     $query->bindParam(':DirectorName',$AName,PDO::PARAM_STR);
...
{               ?>
                                    <form method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="DirectorName" value="<?php  echo $row->DirectorName;?>" required='true'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
