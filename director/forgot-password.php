...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tbldirector WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tbldirector set Password=:newpassword where Email=:email and MobileNumber=:mobile";
