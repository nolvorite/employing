...
$sql="insert into tblskill(skill_name, skill_comment) values (:skill,:description)";
...
$query->bindParam(':description',$description,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Skill has been created.")</script>';
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Job Portal - Add Skill</title>
          ...
          <?php include_once('includes/header.php');?>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <!-- Register Forms -->
                    <h2 class="content-heading">Add Skill</h2>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Bootstrap Register -->
                            <div class="block block-themed">
                                <div class="block-header bg-gd-skill">
                                    <h3 class="block-title">Add Skill</h3>
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-email">Skill Title:</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" value="" name="skill" required="true">
                                            </div>
                                        </div>
                                        <div class="form-group row">
