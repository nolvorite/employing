                            ...
                            <!-- DataTables init on table by adding .js-dataTable-full-pagination class, functionality initialized in js/pages/be_tables_datatables.js -->
                               <form id="basic-form" method="post">
                                <div class="form-group">
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Candidate Mobile Number" maxlength="10" pattern="[0-9]+"></div>
...
$sdata=$_POST['searchdata'];
  ...
  <div class="block-header bg-gd-emerald">
                            ...
                            <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination">
                                ...
                                <tbody>
                                    <?php
$sql="SELECT * from tbljobseekers where ContactNumber like '$sdata%'";
