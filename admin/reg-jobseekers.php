...
{               ?>
                                    <tr id="tr_<?php echo htmlentities ($row->id);?>">
                                        ...
                                        <td class="d-none d-sm-table-cell"><?php  echo htmlentities($row->RegDate);?></td>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a href="view-jobseeker-details.php?viewid=<?php echo htmlentities ($row->id);?>"><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;<a onclick="delete_student(<?php echo ($row->id);?>)" ><i class="fa fa-trash fa-delete text-danger" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
        ...
        <script>
            function delete_student(a) {
                if(confirm('Do you really want to Delete ?')){
                    $.ajax({
                        url: "delete-service.php?type=student",
                        type: 'post',
                        data: {id: a},
