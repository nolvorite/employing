...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-crop"></i><span class="sidebar-mini-hide"></span>Job Industry</a>
                                    <ul>
                                        <li>
                                            <a href="add-industry.php">Add Indutry</a>
                                        </li>
                                        <li>
                                            <a href="manage-industry.php">Manage Industry</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-tag"></i><span class="sidebar-mini-hide"></span>Job Type</a>
                                    <ul>
                                        <li>
                                            <a href="add-type.php">Add Type</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu"><i class="si si-paper-clip"></i><span class="sidebar-mini-hide"></span>Skill</a>
                                    <ul>
                                        <li>
                                            <a href="add-skill.php">Add Skill</a>
                                        </li>
                                        <li>
                                            <a href="manage-skill.php">Manage Skill</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
