...
{               ?>
                                    <tr id="tr_<?php echo htmlentities ($row->id);?>">
                                        ...
                                        <td class="d-none d-sm-table-cell">$<?php  echo htmlentities($row->PostingDate);?></td>
                                         ...
                                         <td class="d-none d-sm-table-cell"><a onclick="delete_category(<?php echo ($row->id);?>)" ><i class="fa fa-trash fa-delete text-danger" aria-hidden="true"></i></a> &nbsp;&nbsp;<a href="edit-category.php?editid=<?php echo htmlentities ($row->id);?>"><i class="fa fa-edit" aria-hidden="true"></i></a></td>
                                    </tr>
                                    <?php $cnt=$cnt+1;}} ?> 
        ...
        <script>
            function delete_category(a) {
                if(confirm('Do you really want to Delete ?')){
                    $.ajax({
                        url: "delete-service.php?type=category",
                        type: 'post',
                        data: {id: a},
